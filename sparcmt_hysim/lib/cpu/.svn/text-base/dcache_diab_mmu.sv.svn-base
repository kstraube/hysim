//------------------------------------------------------------------------------------------
// File:        dcache_diab_mmu.sv
// Author:      Zhangxi Tan
// Description: Non-blocking per-thread D$ implemenation with mmu support. Currently, direct-map, write-back, 
...
module dcache_udc #(parameter CACHEDATAPROT = 2, parameter AUTORECOVER = 0, parameter read2x = 0, parameter write2x = 0, parameter MMUREFBIT=0, parameter MMUDIRTYBIT=0)  //protect with ECC 
...
//    new_dtag.tag.D = dmmu2cache.paddr[31:DCACHETAGLSB];
    ...
    //write tag & data        
    cache_hit = (delr_xc.dc_tag.tag.D[31:DCACHETAGLSB] == new_dtag.tag.D[31:DCACHETAGLSB])? delr_xc.dc_tag.valid : '0; //treat non-mem ops as cache hit               
