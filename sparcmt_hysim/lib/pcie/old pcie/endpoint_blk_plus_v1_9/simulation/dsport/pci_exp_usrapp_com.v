    ...
    reg  [3:0]  _rem;
      ...
      for (_i = 0; _i < _rem; _i = _i + 1) begin
        ...
        if (txrx) begin
          ...
          board.xilinx_pci_exp_1_lane_downstream_port.com_usrapp.frame_store_tx[board.xilinx_pci_exp_1_lane_downstream_port.com_usrapp.frame_store_tx_idx] = _byte;
          board.xilinx_pci_exp_1_lane_downstream_port.com_usrapp.frame_store_tx_idx = board.xilinx_pci_exp_1_lane_downstream_port.com_usrapp.frame_store_tx_idx + 1;

        end else begin

          board.xilinx_pci_exp_1_lane_downstream_port.com_usrapp.frame_store_rx[board.xilinx_pci_exp_1_lane_downstream_port.com_usrapp.frame_store_rx_idx] = _byte;
          board.xilinx_pci_exp_1_lane_downstream_port.com_usrapp.frame_store_rx_idx = board.xilinx_pci_exp_1_lane_downstream_port.com_usrapp.frame_store_rx_idx + 1;
        end
