...
add wave -noupdate /sim_top/sim/gen_cpu/ldst_out
...
add wave -noupdate -expand -subitemconfig {/sim_top/sim/gen_cpu/memr.ts -expand} /sim_top/sim/gen_cpu/memr
...
WaveRestoreCursors {{Cursor 1} {249204078 ps} 0}
...
update
WaveRestoreZoom {233971730 ps} {267396266 ps}
