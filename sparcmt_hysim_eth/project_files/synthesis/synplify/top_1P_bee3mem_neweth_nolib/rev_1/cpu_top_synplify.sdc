...
#define_attribute [get_cells {gen_cpu.pcie_interface.ep.pcie_ep0.pcie_blk.pcie_mim_wrapper_i.bram_retry.genblk197®generate_sdp®ram_sdp_inst}]  {xc_rloc}  {RAMB36_X3Y12} 
define_attribute  {i:gen_cpu.pcie_interface.ep.pcie_ep0.pcie_blk.pcie_mim_wrapper_i.bram_retry.genblk197\.generate_sdp\.ram_sdp_inst} {xc_rloc} {RAMB36_X3Y12} 

#define_attribute [get_cells {gen_cpu.pcie_interface.ep.pcie_ep0.pcie_blk.pcie_mim_wrapper_i.bram_tl_tx.genblk197®genblk198®genblk199®generate_tdp2Û1Ý®ram_tdp2_inst}]  {xc_rloc}  {RAMB36_X3Y11} 
define_attribute  {i:gen_cpu.pcie_interface.ep.pcie_ep0.pcie_blk.pcie_mim_wrapper_i.bram_tl_tx.genblk197\.genblk198\.genblk199\.generate_tdp2\[1\]\.ram_tdp2_inst} {xc_rloc} {RAMB36_X3Y11} 

#define_attribute [get_cells {gen_cpu.pcie_interface.ep.pcie_ep0.pcie_blk.pcie_mim_wrapper_i.bram_tl_rx.genblk197®genblk198®genblk199®generate_tdp2Û1Ý®ram_tdp2_inst}]  {xc_rloc}  {RAMB36_X3Y10} 
define_attribute  {i:gen_cpu.pcie_interface.ep.pcie_ep0.pcie_blk.pcie_mim_wrapper_i.bram_tl_rx.genblk197\.genblk198\.genblk199\.generate_tdp2\[1\]\.ram_tdp2_inst} {xc_rloc} {RAMB36_X3Y10} 

#define_attribute [get_cells {gen_cpu.pcie_interface.ep.pcie_ep0.pcie_blk.pcie_mim_wrapper_i.bram_tl_tx.genblk197®genblk198®genblk199®generate_tdp2Û0Ý®ram_tdp2_inst}]  {xc_rloc}  {RAMB36_X3Y9} 
define_attribute  {i:gen_cpu.pcie_interface.ep.pcie_ep0.pcie_blk.pcie_mim_wrapper_i.bram_tl_tx.genblk197\.genblk198\.genblk199\.generate_tdp2\[0\]\.ram_tdp2_inst} {xc_rloc} {RAMB36_X3Y9} 

#define_attribute [get_cells {gen_cpu.pcie_interface.ep.pcie_ep0.pcie_blk.pcie_mim_wrapper_i.bram_tl_rx.genblk197®genblk198®genblk199®generate_tdp2Û0Ý®ram_tdp2_inst}]  {xc_rloc}  {RAMB36_X3Y8} 
define_attribute  {i:gen_cpu.pcie_interface.ep.pcie_ep0.pcie_blk.pcie_mim_wrapper_i.bram_tl_rx.genblk197\.genblk198\.genblk199\.generate_tdp2\[0\]\.ram_tdp2_inst} {xc_rloc} {RAMB36_X3Y8} 

#define_attribute [get_cells {gen_cpu.pcie_interface.ep.pcie_ep0.pcie_blk.SIO.genblk215®genblk216®pcie_gt_wrapper_i.genblk210®GTDÛ0Ý®GT_i}]  {xc_rloc}  {GTP_DUAL_X0Y4} 
define_attribute  {i:gen_cpu.pcie_interface.ep.pcie_ep0.pcie_blk.SIO.genblk215\.genblk216\.pcie_gt_wrapper_i.genblk210\.GTD\[0\]\.GT_i} {xc_rloc} {GTP_DUAL_X0Y4} 
...
#define_clock -internal  {4} [get_nets {gen_cpu.pcie_interface.ep.pcie_ep0.pcie_blk.clocking_i.clkout0}] -name  {pcie_clocking_4s_0s_8s|clkout0_derived_clock_CLKIN1} -ref_rise  {0.000000} -ref_fall  {2.000000} -uncertainty  {0.000000} -period  {4.000000} -clockgroup  {default_clkgroup_11} -rise  {0.000000} -fall  {2.000000} 
#define_clock -internal  {4} [get_nets {gen_cpu.pcie_interface.ep.pcie_ep0.pcie_blk.clocking_i.clkfbout}] -name  {pcie_clocking_4s_0s_8s|clkfbout_derived_clock_CLKIN1} -ref_rise  {0.000000} -ref_fall  {5.000000} -uncertainty  {0.000000} -period  {10.000000} -clockgroup  {default_clkgroup_11} -rise  {0.000000} -fall  {5.000000} 
#define_clock -internal  {4} [get_nets {gen_cpu.pcie_interface.ep.pcie_ep0.pcie_blk.clocking_i.clkout1}] -name  {pcie_clocking_4s_0s_8s|clkout1_derived_clock_CLKIN1} -ref_rise  {0.000000} -ref_fall  {8.000000} -uncertainty  {0.000000} -period  {16.000000} -clockgroup  {default_clkgroup_11} -rise  {0.000000} -fall  {8.000000} 
#define_clock -internal  {4} [get_nets {gen_cpu.pcie_interface.ep.pcie_ep0.pcie_blk.clocking_i.clkout2}] -name  {pcie_clocking_4s_0s_8s|clkout2_derived_clock_CLKIN1} -ref_rise  {0.000000} -ref_fall  {4.000000} -uncertainty  {0.000000} -period  {8.000000} -clockgroup  {default_clkgroup_11} -rise  {0.000000} -fall  {4.000000} 
#define_clock -internal  {4} [get_nets {gen_cpu.pcie_interface.ep.pcie_ep0.pcie_blk.clocking_i.txsync_clkout}] -name  {pcie_clocking_4s_0s_8s|txsync_clkout_derived_clock_CLKIN1} -ref_rise  {0.000000} -ref_fall  {4.000000} -uncertainty  {0.000000} -period  {8.000000} -clockgroup  {default_clkgroup_11} -rise  {0.000000} -fall  {4.000000} 
