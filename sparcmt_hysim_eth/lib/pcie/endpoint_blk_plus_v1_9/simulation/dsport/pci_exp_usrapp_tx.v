...
initial begin
        ...
        DEV_VEN_ID = (32'h00005050 << 16) | (32'h000010EE);
    ...
    task TSK_TX_SYNCHRONIZE;
        ...
        begin
            ...
            if (first_ == 1'b1) begin
                ...
                board.xilinx_pci_exp_1_lane_downstream_port.com_usrapp.TSK_READ_DATA(last_,
                                                                            `TX_LOG,
                                                                            trn_td,
                                                                            trn_trem_n);
            end
            ...
            if (last_call_)
                 ...
                 board.xilinx_pci_exp_1_lane_downstream_port.com_usrapp.TSK_PARSE_FRAME(`TX_LOG);
        end
  ...
  *************************************************************/
  task TSK_SIMULATION_TIMEOUT;
    input [31:0] timeout;
    begin
      force board.xilinx_pci_exp_1_lane_downstream_port.rx_usrapp.sim_timeout = timeout;
    end
  endtask
   ...
   *************************************************************/
    ...
    CFG_DWADDR = 10'h0;
    board.xilinx_pci_exp_1_lane_downstream_port.cfg_usrapp.TSK_READ_CFG_DW(CFG_DWADDR);
