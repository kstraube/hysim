     ...
     float32 trueFunction( int32 ), float32 testFunction( int32 ) )
{
    ...
    while ( ! testCases_done || forever ) {
        ...
        *trueFlagsPtr = 0;
        ...
        if ( ( trueZ != testZ ) || ( trueFlags != testFlags && doTestFlags ) ) {
            if (    ! checkNaNs
                 && float32_isNaN( trueZ )
                 && float32_isNaN( testZ )
     ...
     float64 trueFunction( int32 ), float64 testFunction( int32 ) )
{
    ...
    while ( ! testCases_done || forever ) {
        ...
        *trueFlagsPtr = 0;
        ...
        if ( ! float64_same( trueZ, testZ ) || ( trueFlags != testFlags && doTestFlags ) ) {
            if (    ! checkNaNs
                 && float64_isNaN( trueZ )
                 && float64_isNaN( testZ )
     ...
     floatx80 trueFunction( int32 ), floatx80 testFunction( int32 ) )
{
    ...
    while ( ! testCases_done || forever ) {
        ...
        *trueFlagsPtr = 0;
        ...
        if ( ! floatx80_same( trueZ, testZ ) || ( trueFlags != testFlags && doTestFlags ) ) {
            if (    ! checkNaNs
     ...
     float128 trueFunction( int32 ), float128 testFunction( int32 ) )
{
    ...
    while ( ! testCases_done || forever ) {
        ...
        *trueFlagsPtr = 0;
        ...
        if ( ! float128_same( trueZ, testZ ) || ( trueFlags != testFlags && doTestFlags ) ) {
            if (    ! checkNaNs
